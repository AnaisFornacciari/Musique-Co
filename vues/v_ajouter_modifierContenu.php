...
if(isset($idContenu))
{
    $action = "validerModifContenu-".$idContenu;
}
else
{
    $action = "validerAjoutContenu";
}
?>
...
<div id="band" class="container text-center">
    ...
    <form action="<?php echo $action ?>" method="post">
        ...
        <p><em> <input class="form-control" type="text" value="<?php if(isset($leContenu['titre'])) { echo $leContenu['titre']; } ?>" name="titre" <?php if(isset($leContenu['titre'])) { echo $leContenu['titre']; } ?> maxlength="100"/> </em></p><br>
        ...
        <label for="contenu">Contenu :</label>
            <div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
                ...
                <div id="editor" class="form-control">
                    <?php if(isset($leContenu['leContenu'])) { echo $leContenu['leContenu']; } ?>
                </div>
            </div>
        <br>
