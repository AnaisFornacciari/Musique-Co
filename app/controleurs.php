...
Class ControleurActionsAdmin
{
    ...
    public function validerModifProf(Request $request, Application $app)
    {
        ...
        if($image == "")
        {$this->pdo->modifierProfSansImage($idProf, $nom, $prenom, $discipline);}
        else {$this->pdo->modifierProf($idProf, $nom, $prenom, $discipline, "../public/images/profs/".$image);}
        ob_get_clean();
        return $app->redirect('afficher-13');
    }
    ...
    public function validerModifMessage(Request $request, Application $app)
    {
        ...
        ob_get_clean();
        return $app->redirect('afficher-1');
    }
