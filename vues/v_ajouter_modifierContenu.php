...
<div id="band" class="container text-center">
    ...
    <br>
    <form action="validerModifContenu-<?php echo $idContenu ?>" method="post">
        <?php
        if(isset($leContenu['titre']))
        {
            ?> <label for="titre">Titre :</label>
            <br><p><em> <input class="form-control" type="text" value="<?php echo $leContenu['titre'] ?>" name="titre" <?php echo $leContenu['titre'] ?> maxlength="100"/> </em></p><br> <?php 
        }
